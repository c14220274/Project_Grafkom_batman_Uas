...
class Main {
    static init() {
        ...
        const texture = loader.load([
            'GothamSkybox/CubemapGotham_R.jpg',  // Right
            'GothamSkybox/CubemapGotham_L.jpg',   // Left
            'GothamSkybox/CubemapGotham_D.jpg',    // Top
            'GothamSkybox/CubemapGotham_U.jpg', // Bottom
            'GothamSkybox/CubemapGotham_F.jpg',  // Front
            'GothamSkybox/CubemapGotham_B.jpg'    // Back
        ]);
        this.scene.background = texture;


        // Plane
        var planeTexture = new THREE.TextureLoader().load('plainstone/cobble.png');
        ...
        //----------------------------- BASKET BALL COURT ---------------------------------------
        var basketballCourtTexture = new THREE.TextureLoader().load('BasketBall/basketballcourt.jpg');
        ...
        loaderHoop.load('BasketBall/basketballhoop.fbx', (loadedObjectHoop) => {
      ...
      //---------------------------------- JOKER IN A BOX --------------------------------------
       //---------------------------------- JOKER IN A BOX --------------------------------------
       var boxHelperJoker;
       var jokerTexture = new THREE.TextureLoader().load('Joker/IOS_Joker_V_Diff.jpg');
       const loaderJoker = new FBXLoader();
       loaderJoker.load('Joker/Joker.fbx', (loadedObjectJoker) => {
      ...
      //----------------------------------------------------------------------------------------
        ...
        loaderSignal.load('bat-signal/batsignal.fbx', (loadedObjectSignal) => {
        ...
        loader2.load('bat-signal/batlogo.fbx', (loadedObject2) => {
        ...
        loaderSeat.load('Equipments/ShrimpleStair.fbx', (loadedObjectSeat) => {
        ...
        //-------------------------------------- GYM ---------------------------------------------
        var gymcarpetTexture = new THREE.TextureLoader().load('Equipments/carpet.jpg');
        ...
        loaderGym.load('Equipments/gym.fbx', (loadedObjectGym) => {
        ...
        loaderGate.load('gate/gate.fbx', (object) => {
        ...
        loaderGate3.load('gate/gate.fbx', (object) => {
            loaderGate2 = object;
        ...
        loaderfence.load('Fence/fence.fbx', (loaderfence) => {
        ...
        var brickTexture = new THREE.TextureLoader().load('Jail/K_BuildingB_09.jpg');
        const loaderJail = new FBXLoader();
        loaderJail.load('Jail/K_Building B_09.fbx', (loadedObjectJail) => {
        ...
        loaderTower.load('WatchTower/wooden watch tower2.fbx', (loadedObjectTower) => {
        ...
        loaderSpeaker.load('loudspeaker-tower/source/Tower.FBX', (loadedObjectSpeaker) => {
        ...
        loaderPicnic.load('picnic/picnic.fbx', (loadedObjectPicnic) => {
        ...
        loaderStatue.load('Batman_Statue/ORN_Statues_Batman.fbx', (loadedObjectStatue) => {
        ...
        loaderGar.load('gotham2/gargoyle/Gargoyle_Ram_v2.fbx', (loadedObjectGar) => {
...
let animationFrame = null; // Declare animationFrame globally
        ...
        loader7.load('batwing/Batwing_ArkhamKnight.fbx', (object) => {
